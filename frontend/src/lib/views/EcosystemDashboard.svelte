...
/**
  ...
  import WabiCard from '../components/ui/WabiCard.svelte';
  import WabiStatCard from '../components/ui/WabiStatCard.svelte';
  import WabiButton from '../components/ui/WabiButton.svelte';
  import WabiSpinner from '../components/ui/WabiSpinner.svelte';
  import WabiBadge from '../components/ui/WabiBadge.svelte';
...
<style>
  ...
  .dashboard-header {
    ...
    align-items: center;
    margin-bottom: var(--space-3, 34px);
    padding-bottom: var(--space-2, 21px);
  ...
  .main-grid {
    ...
    gap: var(--space-3, 34px);
    margin-top: var(--space-3, 34px);
  }
  ...
  .empty-state {
    ...
    color: var(--color-ink-light, #57534e);
    text-align: center;
    padding: var(--space-2, 21px);
  }

  .error-toast {
    position: fixed;
    bottom: var(--space-3, 34px);
    right: var(--space-3, 34px);
