...
import { GetActiveBankAccounts } from "../../../wailsjs/go/main/FinanceService";
    ...
    function initializeEditableData() {
        ...
        editableData = {
            division: (typeof data.division === 'string' && data.division.trim() !== '') ? data.division : "Acme Instrumentation",
    ...
    function saveDocument() {
        ...
        dispatch('save', {
            ...
            documentData: {
                ...editableData,
                division: editableData.division || 'Acme Instrumentation',
                total: finalTotal,
    ...
    let filteredBankAccounts = $derived(bankAccounts.filter((account) => (account.division || "Acme Instrumentation") === editableData.division));
