    ...
    <div class="step-body" in:fade={{ duration: motionMs(200) }}>
            ...
            <div class="path-row" in:fly={{ y: 8, duration: motionMs(180) }}>
              <div class="path-input-wrap">
                <input
                  ...
                  placeholder={`e.g. /Users/yourname/OneDrive - ${getDefaultDivisionKey()}/Offers/2025`}
      ...
      <div class="card tips-card">
        ...
        <ul class="tips-list">
          ...
          <li>On Windows, usually <code>C:\Users\You\OneDrive - {getDefaultDivisionKey()} WLL\Offers\2025</code></li>
